...
from app.routers import auth, shifts, inventory, discounts, products, users, rewards, rules, cafes, admins, tables, cinema, coworking, events, reservations, orders, payments
